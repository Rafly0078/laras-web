 ...
 *
 *  Asal    : src/utils/Lyrics/Animator/Lyrics/LyricsAnimator.ts
...
// apa yang hilang karenanya. `@ts-ignore` upstream di bawah dibiarkan walau
// kini tak perlu — tipe cubic-spline disediakan shim/cubic-spline.d.ts.
// @ts-ignore pkg has no @types on npm
import Spline from "cubic-spline";
import { easeSinOut } from "d3-ease";
import { $currentLyricsType, $simpleLyricsMode, $simpleLyricsModeRenderingType } from "../../../../shim/stores";
import { LyricsObject, SimpleLyricsMode_LetterEffectsStrengthConfig, preHiddenDotLineMs } from "../../../../shim/lyrics";
import { BlurMultiplier, timeOffset } from "../Shared";
import { setOnNewElementMounted } from "../../../../shim/LyricsVirtualizer";
